                                    ...
                                    <div class="w-full md:w-auto text-right mt-1">
                                        <?php if ($status === 'Lunas' || $status === 'Selesai'): ?>
                                            <div class="flex gap-1.5">
                                                ...
                                                <a href="kuitansi.php?token=<?= $b['token_kuitansi'] ?>" target="_blank" class="inline-flex items-center justify-center gap-xs bg-success-green hover:bg-success-green/90 text-white font-bold px-3 py-1.5 rounded-lg hover:shadow-md transition-all decoration-none text-xs text-center active:scale-95 shadow-xs">

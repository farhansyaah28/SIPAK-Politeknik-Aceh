    ...
    <div class="flex-1 flex flex-col min-w-0 bg-surface-blue relative overflow-y-auto">
        ...
        <main class="p-lg space-y-md">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-md">
                ...
                <div class="bg-white p-md rounded-2xl border border-outline-variant shadow-soft flex flex-col justify-between bento-card relative">
                    <div class="flex items-start justify-between">
                        <div>
                    ...
                    <?php if ($pending_val > 0): ?>
                        <span class="absolute top-2.5 right-2.5 w-2 h-2 rounded-full bg-error-red animate-pulse" title="<?= $pending_val ?> butuh validasi"></span>
                    <?php endif; ?>
                </div>
